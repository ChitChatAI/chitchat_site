...
const pageTitles: Record<string, string> = {
  ...
  '/solutions': 'ChitChat AI | AI Solutions - Custom Digital Humans for Business',
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      ...
      const descriptions: Record<string, string> = {
        ...
        '/solutions': 'Explore our AI solutions for customer service, sales, and support with emotionally intelligent digital humans.',
