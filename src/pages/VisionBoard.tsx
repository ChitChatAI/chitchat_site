                        ...
                        <article className="prose prose-lg md:prose-xl prose-invert prose-slate mx-auto">
                            ...
                            <div className="space-y-8"> {/* Added container with improved spacing */}
                                ...
                                <div className="my-12 p-6 bg-blue-50 rounded-lg">
                                    ...
                                    <p className="text-gray-800">Customer service doesn't always need a person, but it does need to feel personal.</p>
                                    <p className="mt-3 text-gray-800">At ChitChat, we build AI personas that can fully manage certain conversations on their own. In cases where the issue is clear and the tone is handled well, there's no need to hand off to a human. The AI can take care of it from start to finish.</p>
                                    <p className="mt-3 text-gray-800">But we also know some moments are too complex, too sensitive, or too unpredictable to automate entirely. That's why our system is also built to work alongside real teams when needed, with seamless handovers and no confusion.</p>
                                    <p className="mt-3 text-gray-800">We're not removing the human from customer service. We're just giving businesses the option to decide where they still need one.</p>
                                </div>
                                ...
                                <div className="my-12 p-6 bg-yellow-50 rounded-lg pb-24">
                                    ...
                                    <p className="text-gray-800">I didn't come from a tech background. I studied psychology because I've always been interested in how people think, how they communicate, and what makes conversations actually work.</p>
                                    <p className="mt-3 text-gray-800">So, when I started looking into AI and customer service, it hit me pretty quickly:<br />
                                        Most of these systems don't understand people at all.</p>
                                    <p className="mt-3 text-gray-800">They respond fast, but they don't actually connect. They handle basic questions, but they don't handle tone, frustration, or nuance - the things that actually matter in a real conversation.</p>
                                    <p className="mt-3 text-gray-800">That's where the idea for ChitChat started.</p>

                                    <h3 className="text-lg font-medium text-yellow-800 mt-4 mb-2">What I Wanted to Build</h3>
                                    <p className="text-gray-800">I wanted to create AI that didn't sound like AI. Something that could talk to people the way a good support agent would - calm when it needs to be, warm when it helps, and direct when it matters.</p>
                                    <p className="mt-3 text-gray-800">I wasn't trying to create the most technical product. I wanted to create the most human one. And I knew that meant starting with personality, tone, and emotional awareness, not just functionality.</p>

                                    <h3 className="text-lg font-medium text-yellow-800 mt-4 mb-2">Where We're Headed</h3>
                                    <p className="text-gray-800">ChitChat is still growing. We're building new personas, improving the way they interact, and making it easier for businesses to plug in voices that actually sound like they belong.</p>
                                    <p className="mt-3 text-gray-800">We're not trying to copy human agents. We're building AI that's smart, clear, and emotionally aware, so it can hold real conversations when it counts.</p>
                                    <p className="mt-3 text-gray-800">And the best part is, this is just the beginning.</p>
                                </div>
