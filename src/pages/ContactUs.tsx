            ...
            <div className="mt-10 flex justify-between items-center pl-8 md:pl-14">
              {currentStep > 1 ? (
                <button
                  ...
                  className="font-satoshi px-5 py-3 rounded-lg font-medium transition-all duration-300 bg-gray-200 text-gray-700 hover:bg-gray-300 active:scale-95 whitespace-nowrap"
                >
                  {/* ...existing code... */}
                  Back
                </button>
              ...
              {currentStep < 3 ? (
                <button
                  ...
                  className="font-satoshi px-5 py-3 rounded-lg font-medium transition-all duration-300 bg-theme-main text-white hover:bg-theme-dark active:scale-95 hover:scale-105 whitespace-nowrap"
                >
                  {/* ...existing code... */}
                  Next
                  {/* ...existing code... */}
                ...
                <button
                  ...
                  className={`font-satoshi px-5 py-3 rounded-lg font-medium transition-all duration-300 text-white whitespace-nowrap
    ${isSubmitting
