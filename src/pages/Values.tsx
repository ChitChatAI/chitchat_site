...
import { ChevronDown, X, Menu, Cookie } from 'lucide-react'; // Add Cookie icon import
        ...
        <>
            ...
            <nav
                className={`fixed top-0 w-full z-50 transition-all duration-300 ${
                    isScrolled 
                    ? 'bg-white shadow-md py-4 xs:py-5 sm:py-6 md:py-7' 
                    : 'bg-transparent py-4 xs:py-5 sm:py-6'
                }`}
            >
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
                    <div className="flex items-center justify-between">
                        ...
                        {/* Desktop Navigation */}
                        <div className="hidden md:flex items-center justify-center space-x-4 lg:space-x-5 xl:space-x-8 2xl:space-x-12">
                            <Link to="/" className={`${getNavLinkClass("/")} text-xs lg:text-sm xl:text-base px-1 py-1.5 hover:opacity-90`}>About Us</Link>
                            <Link to="/values" className={`${getNavLinkClass("/values")} text-xs lg:text-sm xl:text-base px-1 py-1.5 hover:opacity-90`}>Values</Link>
                            <Link to="/solutions" className={`${getNavLinkClass("/solutions")} text-xs lg:text-sm xl:text-base px-1 py-1.5 hover:opacity-90`}>Solutions</Link>
                            <Link to="/partnerships" className={`flex items-center ${getNavLinkClass("/partnerships")} text-xs lg:text-sm xl:text-base px-1 py-1.5 hover:opacity-90`}>
                                <span>Businesses</span>
                            </Link>
                            <Link to="/Vision Board" className={`flex items-center ${getNavLinkClass("/Vision Board")} text-xs lg:text-sm xl:text-base px-1 py-1.5 hover:opacity-90`}>
                                <span>Vision Board</span>
                                <span className="ml-1 px-1.5 py-0.5 text-[10px] lg:text-xs bg-theme-light text-theme-main rounded-full">New</span>
                            </Link>
                            <Link to="/pricing" className={`${getNavLinkClass("/pricing")} text-xs lg:text-sm xl:text-base px-1 py-1.5 hover:opacity-90`}>Pricing</Link>
                            <Link to="/contact us" className={`${getNavLinkClass("/contact us")} text-xs lg:text-sm xl:text-base px-1 py-1.5 hover:opacity-90`}>Contact Us</Link>
                        </div>
