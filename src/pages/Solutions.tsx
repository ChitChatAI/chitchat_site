          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 md:gap-10 max-w-5xl mx-auto">
              {/* Card 1: Telecommunications */}              <div
                className="relative bg-black border border-gray-500 p-6 sm:p-8 shadow-[0_4px_40px_rgba(125,99,210,0.2)] group hover:shadow-[0_8px_60px_rgba(125,99,210,0.35)] transition-all duration-300 rounded-2xl backdrop-blur-md after:absolute after:inset-0 after:rounded-2xl after:ring-1 after:ring-inset after:ring-gray-500/50 flex flex-col cursor-pointer focus-visible:ring-2 focus-visible:ring-gray-500/60 group w-full overflow-hidden"
